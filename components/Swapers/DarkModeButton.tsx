...
const DarkModeButton = ({ setThemeText }: any) => {
  ...
  return (
    <>
      <label className={classes.header.user_area.darkMode.wrapper}>
        {theme === "system" && (
          <button title="تم سایت بر اساس سیستم شما" className="p-0.5">
            <IoContrastOutline
              title="تم سایت بر اساس سیستم شما"
              className="hidden w-6 lg:block text-primary-dark dark:text-primary-light lg:w-7"
              size={27}
            />

            <IoContrastOutline
              title="تم سایت بر اساس سیستم شما"
              className="lg:hidden text-primary-dark dark:text-primary-light"
              size={20}
            />
          </button>
        )}
        ...
        {theme !== "system" && (
          <>
            <svg
              className={`${classes.header.user_area.darkMode.icon} swap-on`}
            ...
            <svg
              className={`${classes.header.user_area.darkMode.icon} swap-off`}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
